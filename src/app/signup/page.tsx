...
import { Circle, ArrowRight, Github, Mail, Lock, User, Eye, EyeOff, Check } from 'lucide-react';
        ...
        <div className="relative">
          ...
          <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-2xl border border-white/20 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400">지식 연결의 시작</p>
            </div>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-black/50 text-gray-400">or sign up with email</span>
              </div>
            </div>
                ...
                {password && (
                  <div className="mt-2 space-y-2">
                    <div className="flex gap-2">
                      <div className={`h-1 flex-1 rounded ${password.length > 0 ? passwordStrength === 'weak' ? 'bg-red-500' : passwordStrength === 'medium' ? 'bg-yellow-500' : 'bg-green-500' : 'bg-white/10'}`}></div>
                      <div className={`h-1 flex-1 rounded ${password.length > 5 ? passwordStrength === 'medium' ? 'bg-yellow-500' : 'bg-green-500' : 'bg-white/10'}`}></div>
                      <div className={`h-1 flex-1 rounded ${password.length > 8 ? 'bg-green-500' : 'bg-white/10'}`}></div>
                    </div>
